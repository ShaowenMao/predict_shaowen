...
function print_help()
    println("Usage:")
    println("  julia --project=examples/Julia_analyses/UQ_workflow examples/Julia_analyses/UQ_workflow/level2/scripts/02_export_tables/export_level2_tables.jl [options]")
    println()
    println("Options:")
