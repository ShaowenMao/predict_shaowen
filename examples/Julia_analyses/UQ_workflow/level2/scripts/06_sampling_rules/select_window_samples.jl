...
include(joinpath(@__DIR__, "..", "..", "lib", "level2_selection.jl"))
...
function print_help()
    println("Usage:")
    println("  julia --project=examples/Julia_analyses/UQ_workflow examples/Julia_analyses/UQ_workflow/level2/scripts/06_sampling_rules/select_window_samples.jl [options]")
    println()
    println("Options:")
