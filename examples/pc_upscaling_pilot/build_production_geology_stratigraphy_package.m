...
%   against its six frozen PREDICT checkpoints and linked to the exact
%   requested set of validated full-slice fault-property MAT files.
%
...
%     'ExpectedCaseIds'      - Required case IDs per geology. Default: 1:10.
%                              Case IDs need not be contiguous.
