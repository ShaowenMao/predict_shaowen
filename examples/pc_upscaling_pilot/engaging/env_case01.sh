...
export KR_DYN_PERMEABILITY_INPUT="${KR_DYN_PERMEABILITY_INPUT:-${PROJECT_ROOT}/inputs/texas_offshore_field_sampling/texas_field_sampling_compact.mat}"
...
echo "KR_DYN_PERMEABILITY_INPUT=${KR_DYN_PERMEABILITY_INPUT}"
