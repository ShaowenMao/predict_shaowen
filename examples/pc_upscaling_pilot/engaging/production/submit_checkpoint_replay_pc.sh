...
if [[ "${MODE}" == "qualification60" ]]; then
    ...
    CHECKPOINT_WALLTIME_DEFAULT="24:00:00"
fi
...
checkpoint_walltime=${CHECKPOINT_WALLTIME:-${CHECKPOINT_WALLTIME_DEFAULT}}
slurm_qos=${SLURM_QOS}
